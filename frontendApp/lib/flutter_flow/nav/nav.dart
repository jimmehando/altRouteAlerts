...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AlertPageWidget.routeName,
          path: AlertPageWidget.routePath,
          requireAuth: true,
          asyncParams: {
            'alertPullTrough': getDoc(['events'], EventsRecord.fromSnapshot),
          },
          builder: (context, params) => AlertPageWidget(
            alertPullTrough: params.getParam(
              'alertPullTrough',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'alertPullThroughHistory':
                getDoc(['history'], HistoryRecord.fromSnapshot),
          },
          builder: (context, params) => HistoryPageWidget(
            alertPullThroughHistory: params.getParam(
              'alertPullThroughHistory',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: SignUpSuccessWidget.routeName,
          path: SignUpSuccessWidget.routePath,
          requireAuth: true,
          builder: (context, params) => SignUpSuccessWidget(),
        ),
        FFRoute(
          name: OptionsWidget.routeName,
          path: OptionsWidget.routePath,
          requireAuth: true,
          builder: (context, params) => OptionsWidget(),
        ),
        FFRoute(
          name: MoreInfoWidget.routeName,
          path: MoreInfoWidget.routePath,
