...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF005826);
  late Color secondary = const Color(0xFFC0C0C0);
  late Color tertiary = const Color(0xFF000000);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF005826);
  ...
  late Color accent1 = const Color(0xFFFFC300);
  late Color accent2 = const Color(0xFFFF8400);
  late Color accent3 = const Color(0xFFFF4D00);
  late Color accent4 = const Color(0xFFFF0000);
  ...
  late Color info = const Color(0xFF007FFF);
}
